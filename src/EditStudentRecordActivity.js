...
export default class EditStudentRecordActivity extends Component {
  ...
  UpdateStudentRecord = () => {
    fetch("http://apps.airfastindonesia.com/rnim/student/UpdateStudentRecord.php", {
      method: "POST",
      headers: {
  ...
  DeleteStudentRecord = () => {
    fetch("http://apps.airfastindonesia.com/rnim/student/DeleteStudentRecord.php", {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json"
  ...
  render() {
    return (
      <View style={styles.MainContainer}>
        ...
        <TextInput
          placeholder="Kelas"
          value={this.state.TextInput_Class}
          onChangeText={TextInputValue =>
            this.setState({ TextInput_Class: TextInputValue })
          }
          underlineColorAndroid="transparent"
          style={styles.TextInputStyleClass}
        />
        ...
        >
          <Text style={styles.TextStyle}> UPDATE DATA STUDENT </Text>
        </TouchableOpacity>
